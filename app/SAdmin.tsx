...
const SAdmin = () => {
    ...
    return (
        <View className="flex-1 bg-[#282828]">
            ...
            >
                <Text className="text-white font-semibold ml-7 mb-4">Added({result.length})</Text>
            ...
            {showForm && (
                <View className="mt-5 p-4 px-14 bg-[#333] mb-80 rounded-lg">
                    {/* 🆕 Upload Button */}
                    <TouchableOpacity onPress={pickImage} className="bg-[#444] p-2 rounded mb-3 items-center">
                        <Text className="text-white">{poster ? "Change Poster" : "Upload Poster"}</Text>
                    </TouchableOpacity>
