...
function TabIcon({ focused, icon, title }: any) {
  if (focused) {
    return (
      <ImageBackground
        className="bg-[#535353] flex flex-row w-full flex-1 min-w-[95px] min-h-[63] mt-4 justify-center items-center rounded-[20] overflow-hidden"
      >
